...
## Pair With Follow Anything

Use this companion when a followed topic needs X/Twitter discovery, profile
lookup, replies, trend checks, monitors, or approved follow-up actions that do
not fit RSS, Atom, podcast, YouTube, iCal, or generic page crawls. Keep local
subscription tracking in Follow Anything and use Hermes Tweet only through the
native toolset.
